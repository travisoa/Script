...
http:\/\/act\.gaoqingdianshi\.com\/\/api\/v4\/sign\/signin\? url script-request-header dianshijia2.js
~~~~~~~~~~~~~~~~

*/
const cookieName = '电视家 📺账号2'
const signurlKey = 'sy_signurl_dsj2'
const signheaderKey = 'sy_signheader_dsj2'
const sy = init()
