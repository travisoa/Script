...
cd ~/
wget --no-check-certificate -O snell.zip https://github.com/surge-networks/snell/releases/download/2.0.0b11/snell-server-v2.0.0-b11-linux-amd64.zip
unzip -o snell.zip
rm -f snell.zip
